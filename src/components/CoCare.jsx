      ...
      <div className="cocare-inner">
        <div className="cocare-visual">
          <div className="cocare-card main-card">
            <div className="cc-header">
              ...
              <div>
                <div className="cc-name">Bart</div>
                <div className="cc-breed">Great Pyrenees · 5 yrs</div>
              </div>
            </div>
        ...
        <div className="cocare-text">
          ...
          <p className="section-sub">
            Invite family members, partners, or trusted sitters by email. Set
            exactly what they can see and do — from full access to log-only.
          ...
          <ul className="cocare-list">
            ...
            <li>
              <span className="check">✓</span>
              Unique permission controls per person
            </li>
            <li>
              <span className="check">✓</span>

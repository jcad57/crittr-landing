...
const features = [
  {
    ...
    desc: 'Name, breed, photos, food preferences, vet clinic, microchip, insurance — everything about your companion in one card.',
  },
  {
    icon: '📋',
    title: 'Activity Logging',
    desc: 'Log walks, meals, treats, medications, and vet visits with timestamps. Review history and edit past entries anytime.',
  },
  {
    icon: '💊',
    title: 'Health Hub',
    desc: 'Track medications, vaccination schedules, weight trends, and upcoming vet visits so nothing slips through the cracks.',
  },
  {
    icon: '✦',
    ...
    <section className="features" id="features">
      <div className="features-inner">
        ...
        <h2 className="section-title">
          Every tool a pet parent<br />
          <em>actually needs</em>
        </h2>
        <p className="section-sub">
          Built around each pet's profile — a calm, organized home for everything about the animal you love.
        </p>
